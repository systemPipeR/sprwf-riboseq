## RIBO-Seq Workflow Template for systemPipeR WMS

<p align="right">
  <a href="https://systempipe.org/sprwf-riboseq/systemPipeRIBOseq.html">
...
Detailed information about this specific `sprwf-riboseq` workflow is available 
[here](https://systempipe.org/sprwf-riboseq/systemPipeRIBOseq.html).
...
genWorkenvir_gh(url = "https://github.com/systemPipeR/sprwf-riboseq.git", mydirname = "sprwf-riboseq")
setwd("sprwf-riboseq")
getParam_gh()
